...
Template.bookingsShow.helpers({
  syncInvoiceToQb: function() {
    return (InvoiceNeedingUpdate.findOne({bookingId: Router.current().params._id}) != undefined && BookingStatuses.findOne({invoiceId: Router.current().params._id}).quickbooksInvoiceId != "Pending");
  },
